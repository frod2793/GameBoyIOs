...
namespace DogGuns_Games.Lobby
{
    public class Lobby_UI_Manager : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("playerDataDontdesytoy")] [Header("플레이어 정보")] [SerializeField]
        private Player_Data_Manager_Dontdesytoy playerDataManagerDontdesytoy;
        ...
        private void CharacterSelct_Init()
        {
            ...
            closeCharacterSelectButton.onClick.AddListener(() =>
            {
                selectCharacterUIManager.CloseCharacterSelectPanel();
            });
        }
